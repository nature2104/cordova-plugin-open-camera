...
import com.cordova.mediacapture.OpenCamera.Preview.ApplicationInterface;
import com.cordova.mediacapture.OpenCamera.Preview.Preview;
import com.cordova.mediacapture.OpenCamera.UI.DrawPreview;
...
public class MyApplicationInterface implements ApplicationInterface {
	...
	private final List<LastImage> last_images = new ArrayList<LastImage>();
	...
	MyApplicationInterface(CaptureActivity main_activity, Bundle savedInstanceState) {
		long debug_time = 0;
		if( MyDebug.LOG ) {
	...
	public void startingVideo() {
		...
		view.setImageResource(main_activity.getResources().getIdentifier("take_video_recording", "drawable", main_activity.getPackageName()));
		view.setContentDescription( getContext().getResources().getString(main_activity.getResources().getIdentifier("stop_video", "string", main_activity.getPackageName())) );
		view.setTag(main_activity.getResources().getIdentifier("take_video_recording", "drawable", main_activity.getPackageName())); // for testing
	...
	public void stoppingVideo() {
		...
		ImageButton view = (ImageButton)main_activity.findViewById(main_activity.getResources().getIdentifier("take_photo", "id", main_activity.getPackageName()));
		view.setImageResource(main_activity.getResources().getIdentifier("take_video_selector", "drawable", main_activity.getPackageName()));
		view.setContentDescription( getContext().getResources().getString(main_activity.getResources().getIdentifier("start_video", "string", main_activity.getPackageName())) );
		view.setTag(main_activity.getResources().getIdentifier("take_video_selector", "drawable", main_activity.getPackageName())); // for testing
	}
	...
	public void stoppedVideo(final int video_method, final Uri uri, final String filename) {
		...
		if( MediaStore.ACTION_VIDEO_CAPTURE.equals(action) ) {
			...
			if( thumbnail != null ) {
				ImageButton galleryButton = (ImageButton) main_activity.findViewById(main_activity.getResources().getIdentifier("gallery", "id", main_activity.getPackageName()));
	...
	public void onVideoInfo(int what, int extra) {
		...
		if( what == MediaRecorder.MEDIA_RECORDER_INFO_MAX_FILESIZE_REACHED ) {
			...
			int message_id = main_activity.getResources().getIdentifier("video_max_filesize", "string", main_activity.getPackageName());
	...
	public void onFailedStartPreview() {
		main_activity.getPreview().showToast(null, main_activity.getResources().getIdentifier("failed_to_start_camera_preview", "string", main_activity.getPackageName()));
	}

	@Override
	public void onCameraError() {
		main_activity.getPreview().showToast(null, main_activity.getResources().getIdentifier("camera_error", "string", main_activity.getPackageName()));
	}

	@Override
	public void onPhotoError() {
	    main_activity.getPreview().showToast(null, main_activity.getResources().getIdentifier("failed_to_take_picture", "string", main_activity.getPackageName()));
	}
	...
	public void onVideoError(int what, int extra) {
		...
		int message_id = main_activity.getResources().getIdentifier("video_error_unknown", "string", main_activity.getPackageName());
		if( what == MediaRecorder.MEDIA_ERROR_SERVER_DIED  ) {
			if( MyDebug.LOG )
				Log.d(TAG, "error: server died");
			message_id = main_activity.getResources().getIdentifier("video_error_server_died", "string", main_activity.getPackageName());
		}
		main_activity.getPreview().showToast(null, message_id);
		// in versions 1.24 and 1.24, there was a bug where we had "info_" for onVideoError and "error_" for onVideoInfo!
		// fixed in 1.25; also was correct for 1.23 and earlier
	...
	public void onVideoRecordStartError(CamcorderProfile profile) {
		...
		if( features.length() > 0 ) {
			error_message = getContext().getResources().getString(main_activity.getResources().getIdentifier("sorry", "string", main_activity.getPackageName())) + ", " + features + " " + getContext().getResources().getString(main_activity.getResources().getIdentifier("not_supported", "string", main_activity.getPackageName()));
		}
		else {
			error_message = getContext().getResources().getString(main_activity.getResources().getIdentifier("failed_to_record_video", "string", main_activity.getPackageName()));
		}
	...
	public void onVideoRecordStopError(CamcorderProfile profile) {
		...
		//main_activity.getPreview().showToast(null, main_activity.getResources().getIdentifier("failed_to_record_video", "string", main_activity.getPackageName()));
		String features = main_activity.getPreview().getErrorFeatures(profile);
		String error_message = getContext().getResources().getString(main_activity.getResources().getIdentifier("video_may_be_corrupted", "string", main_activity.getPackageName()));
		if( features.length() > 0 ) {
			error_message += ", " + features + " " + getContext().getResources().getString(main_activity.getResources().getIdentifier("not_supported", "string", main_activity.getPackageName()));
		}
		main_activity.getPreview().showToast(null, error_message);
	}
	...
	public void onFailedReconnectError() {
		main_activity.getPreview().showToast(null, main_activity.getResources().getIdentifier("failed_to_reconnect_camera", "string", main_activity.getPackageName()));
	}
	
	@Override
	public void onFailedCreateVideoFileError() {
		main_activity.getPreview().showToast(null, main_activity.getResources().getIdentifier("failed_to_save_video", "string", main_activity.getPackageName()));
		ImageButton view = (ImageButton)main_activity.findViewById(main_activity.getResources().getIdentifier("take_photo", "id", main_activity.getPackageName()));
		view.setImageResource(main_activity.getResources().getIdentifier("take_video_selector", "drawable", main_activity.getPackageName()));
		view.setContentDescription( getContext().getResources().getString(main_activity.getResources().getIdentifier("start_video", "string", main_activity.getPackageName())) );
		view.setTag(main_activity.getResources().getIdentifier("take_video_selector", "drawable", main_activity.getPackageName())); // for testing
	...
	public void hasPausedPreview(boolean paused) {
	    View shareButton = main_activity.findViewById(main_activity.getResources().getIdentifier("share", "id", main_activity.getPackageName()));
	    View trashButton = main_activity.findViewById(main_activity.getResources().getIdentifier("trash", "id", main_activity.getPackageName()));
	    if( paused ) {
	...
	public void timerBeep(long remaining_time) {
		...
		if( sharedPreferences.getBoolean(PreferenceKeys.getTimerBeepPreferenceKey(), true) ) {
			...
			main_activity.playSound(is_last ? main_activity.getResources().getIdentifier("beep_hi", "raw", main_activity.getPackageName()) : main_activity.getResources().getIdentifier("beep", "raw", main_activity.getPackageName()));
		}
    ...
    public void setFocusPref(String focus_value, boolean is_video) {
	    ...
	    View focusSeekBar = main_activity.findViewById(main_activity.getResources().getIdentifier("focus_seekbar", "id", main_activity.getPackageName()));
