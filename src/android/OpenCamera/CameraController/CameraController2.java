package com.cordova.mediacapture.OpenCamera.CameraController;
...
public class CameraController2 extends CameraController {
	...
	private final List<byte []> pending_burst_images = new ArrayList<byte []>(); // burst images that have been captured so far, but not yet sent to the application
	...
	private class CameraSettings {
		...
		private boolean setAEMode(CaptureRequest.Builder builder, boolean is_still) {
			...
			if( has_iso ) {
				...
				if(flash_value=="flash_off") {
					builder.set(CaptureRequest.CONTROL_AE_MODE, CameraMetadata.CONTROL_AE_MODE_ON);
					builder.set(CaptureRequest.FLASH_MODE, CameraMetadata.FLASH_MODE_OFF);
				} else if(flash_value=="flash_auto"){
					...
					builder.set(CaptureRequest.FLASH_MODE, CameraMetadata.FLASH_MODE_OFF);
				} else if(flash_value=="flash_torch"){
					builder.set(CaptureRequest.CONTROL_AE_MODE, CameraMetadata.CONTROL_AE_MODE_ON);
					builder.set(CaptureRequest.FLASH_MODE, CameraMetadata.FLASH_MODE_TORCH);
				} else if(flash_value=="flash_red_eye"){
					...
					builder.set(CaptureRequest.FLASH_MODE, CameraMetadata.FLASH_MODE_OFF);
				} else if(flash_value=="flash_frontscreen_auto"
						|| flash_value=="flash_frontscreen_on"){
					builder.set(CaptureRequest.CONTROL_AE_MODE, CameraMetadata.CONTROL_AE_MODE_ON);
					builder.set(CaptureRequest.FLASH_MODE, CameraMetadata.FLASH_MODE_OFF);
				}
			}
	...
	public CameraFeatures getCameraFeatures() {
		...
		if( capabilities_high_speed_video ) {
			...
			camera_features.video_sizes_high_speed = new ArrayList<Size>();
	...
	private void runFakePrecapture() {
		...
		if(camera_settings.flash_value=="flash_auto"
				|| camera_settings.flash_value=="flash_on") {
			if (MyDebug.LOG)
		...
		}else if(camera_settings.flash_value=="flash_frontscreen_auto"
				|| camera_settings.flash_value== "flash_frontscreen_on") {
			if (jpeg_cb != null) {
				if (MyDebug.LOG)
	...
	private boolean fireAutoFlash() {
		...
		if(camera_settings.flash_value == "flash_frontscreen_auto") {
