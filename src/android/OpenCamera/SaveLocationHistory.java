...
public class SaveLocationHistory {
	...
	private final ArrayList<String> save_location_history = new ArrayList<String>();

	/** Creates a new SaveLocationHistory class. This manages a history of save folder locations.
	 * @param main_activity CaptureActivity.
	 * @param pref_base String to use for shared preferences.
	 * @param folder_name The current save folder.
	 */
	SaveLocationHistory(CaptureActivity main_activity, String pref_base, String folder_name) {
		if( MyDebug.LOG )
		...
		updateFolderHistory(folder_name, false); // update_icon can be false, as updateGalleryIcon() is called later in CaptureActivity.onResume()
	 ...
	 * CaptureActivity.updateGalleryIcon().
	 */
