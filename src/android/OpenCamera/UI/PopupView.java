...
public class PopupView extends LinearLayout {
	...
	private final Map<String, View> popup_buttons = new Hashtable<String, View>();
	...
	public PopupView(Context context) {
		...
		final CaptureActivity main_activity = (CaptureActivity)this.getContext();
			...
			Log.d(TAG, "PopupView time 2: " + (System.nanoTime() - debug_time));
		{
	    	...
	    	addButtonOptionsToPopup(supported_flash_values, main_activity.getResources().getIdentifier("flash_icons", "array", main_activity.getPackageName()), main_activity.getResources().getIdentifier("flash_values", "array", main_activity.getPackageName()), getResources().getString(main_activity.getResources().getIdentifier("flash_mode", "string", main_activity.getPackageName())), preview.getCurrentFlashValue(), "TEST_FLASH", new ButtonOptionsPopupListener() {
				@Override
		...
		if( preview.isVideo() && preview.isTakingPhoto() ) {
        	...
        	addButtonOptionsToPopup(supported_focus_values, main_activity.getResources().getIdentifier("focus_mode_icons", "array", main_activity.getPackageName()), main_activity.getResources().getIdentifier("focus_mode_values", "array", main_activity.getPackageName()), getResources().getString(main_activity.getResources().getIdentifier("focus_mode", "string", main_activity.getPackageName())), preview.getCurrentFocusValue(), "TEST_FOCUS", new ButtonOptionsPopupListener() {
    			@Override
    			public void onClick(String option) {
    				if( MyDebug.LOG )
			...
			photo_modes.add( getResources().getString(main_activity.getResources().getIdentifier("photo_mode_standard", "string", main_activity.getPackageName())) );
			photo_mode_values.add( MyApplicationInterface.PhotoMode.Standard );
			if( main_activity.supportsDRO() ) {
				photo_modes.add( getResources().getString(main_activity.getResources().getIdentifier("photo_mode_dro", "string", main_activity.getPackageName())) );
				photo_mode_values.add( MyApplicationInterface.PhotoMode.DRO );
			}
    		if( main_activity.supportsHDR() ) {
    			photo_modes.add( getResources().getString(main_activity.getResources().getIdentifier("photo_mode_hdr", "string", main_activity.getPackageName())) );
    			photo_mode_values.add( MyApplicationInterface.PhotoMode.HDR );
    		}
    		if( main_activity.supportsExpoBracketing() ) {
    			photo_modes.add( getResources().getString(main_activity.getResources().getIdentifier("photo_mode_expo_bracketing", "string", main_activity.getPackageName())) );
        	...
        	if( main_activity.supportsAutoStabilise() ) {
        		...
        		checkBox.setText(getResources().getString(main_activity.getResources().getIdentifier("preference_auto_stabilise", "string", main_activity.getPackageName())));
					...
					public void onCheckedChanged(CompoundButton buttonView,
	            		...
	            		if( isChecked ) {
	            			...
	            			if( !done_auto_stabilise_info ) {
	            				showInfoDialog(main_activity.getResources().getIdentifier("preference_auto_stabilise", "string", main_activity.getPackageName()), main_activity.getResources().getIdentifier("auto_stabilise_info", "string", main_activity.getPackageName()), PreferenceKeys.getAutoStabiliseInfoPreferenceKey());
		        	    		done_dialog = true;
	            			}
	                    }

	            		if( !done_dialog ) {
	            			String message = getResources().getString(main_activity.getResources().getIdentifier("preference_auto_stabilise", "string", main_activity.getPackageName())) + ": " + getResources().getString(isChecked ? main_activity.getResources().getIdentifier("on", "string", main_activity.getPackageName()) : main_activity.getResources().getIdentifier("off", "string", main_activity.getPackageName()));
    		...
    		addArrayOptionsToPopup(picture_size_strings, getResources().getString(main_activity.getResources().getIdentifier("preference_resolution", "string", main_activity.getPackageName())), false, picture_size_index, false, "PHOTO_RESOLUTIONS", new ArrayOptionsPopupListener() {
    		...
    		final String [] timer_values = getResources().getStringArray(main_activity.getResources().getIdentifier("preference_timer_values", "array", main_activity.getPackageName()));
        	String [] timer_entries = getResources().getStringArray(main_activity.getResources().getIdentifier("preference_timer_entries", "array", main_activity.getPackageName()));
        	...
        	final String [] burst_mode_values = getResources().getStringArray(main_activity.getResources().getIdentifier("preference_burst_mode_values", "array", main_activity.getPackageName()));
        	String [] burst_mode_entries = getResources().getStringArray(main_activity.getResources().getIdentifier("preference_burst_mode_entries", "array", main_activity.getPackageName()));
        	...
        	final String [] grid_values = getResources().getStringArray(main_activity.getResources().getIdentifier("preference_grid_values", "array", main_activity.getPackageName()));
        	String [] grid_entries = getResources().getStringArray(main_activity.getResources().getIdentifier("preference_grid_entries", "array", main_activity.getPackageName()));
			...
			if( preview.getCameraController() != null ) {
				...
				if( supported_white_balances != null ) {
					supported_white_balances_entries = new ArrayList<String>();
				...
				addRadioOptionsToPopup(sharedPreferences, supported_white_balances_entries, supported_white_balances, getResources().getString(main_activity.getResources().getIdentifier("white_balance", "string", main_activity.getPackageName())), PreferenceKeys.getWhiteBalancePreferenceKey(), preview.getCameraController().getDefaultWhiteBalance(), "TEST_WHITE_BALANCE", new RadioOptionsListener() {
					@Override
				...
				if( supported_scene_modes != null ) {
					supported_scene_modes_entries = new ArrayList<String>();
				...
				addRadioOptionsToPopup(sharedPreferences, supported_scene_modes_entries, supported_scene_modes, getResources().getString(main_activity.getResources().getIdentifier("scene_mode", "string", main_activity.getPackageName())), PreferenceKeys.getSceneModePreferenceKey(), preview.getCameraController().getDefaultSceneMode(), "TEST_SCENE_MODE", new RadioOptionsListener() {
					@Override
					public void onClick(String selected_value) {
						if( preview.getCameraController() != null ) {
							if( preview.getCameraController().sceneModeAffectsFunctionality() ) {
								...
								main_activity.updateForSettings(getResources().getString(main_activity.getResources().getIdentifier("scene_mode", "string", main_activity.getPackageName())) + ": " + main_activity.getMainUI().getEntryForSceneMode(selected_value));
				...
				if( supported_color_effects != null ) {
					supported_color_effects_entries = new ArrayList<String>();
				...
				addRadioOptionsToPopup(sharedPreferences, supported_color_effects_entries, supported_color_effects, getResources().getString(main_activity.getResources().getIdentifier("color_effect", "string", main_activity.getPackageName())), PreferenceKeys.getColorEffectPreferenceKey(), preview.getCameraController().getDefaultColorEffect(), "TEST_COLOR_EFFECT", new RadioOptionsListener() {
					@Override
					public void onClick(String selected_value) {
						if( preview.getCameraController() != null ) {
	...
	public void switchToWhiteBalance(String selected_value) {
		...
		//main_activity.updateForSettings(getResources().getString(main_activity.getResources().getIdentifier("white_balance", "string", main_activity.getPackageName())) + ": " + selected_value);
		//main_activity.closePopup();
	}
	 ...
	 *                                  CaptureActivity.updateForSettings() and close the popup. If
			...
			button.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View view) {
					...
					if( opened ) {
						//rg.removeAllViews();
						rg.setVisibility(View.GONE);
						final ScrollView popup_container = (ScrollView) main_activity.findViewById(main_activity.getResources().getIdentifier("popup_container", "id", main_activity.getPackageName()));
    ...
    private void addArrayOptionsToPopup(final List<String> supported_options, final String title, final boolean title_in_options, final int current_index, final boolean cyclic, final String test_key, final ArrayOptionsPopupListener listener) {
		if( supported_options != null && current_index != -1 ) {
			...
			//prev_button.setBackgroundResource(main_activity.getResources().getIdentifier("exposure", "drawable", main_activity.getPackageName()));
    ...
    private void showInfoDialog(int title_id, int info_id, final String info_preference_key) {
        ...
        alertDialog.setNegativeButton(main_activity.getResources().getIdentifier("dont_show_again", "string", main_activity.getPackageName()), new DialogInterface.OnClickListener() {
			@Override
